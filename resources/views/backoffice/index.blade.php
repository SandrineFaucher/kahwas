        ...
        <form action="{{ route('campagnes.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('reduction') is-invalid" @enderror  id="formGroupExampleInput2"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_debut') is-invalid" @enderror id="formGroupExampleInput2"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_fin') is-invalid" @enderror id="formGroupExampleInput2"
            ...
            <div class="row">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox"  id="flexCheckDefault" name="articleId{{$article->id}}" >
